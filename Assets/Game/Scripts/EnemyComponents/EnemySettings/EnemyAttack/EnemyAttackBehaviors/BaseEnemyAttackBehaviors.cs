...
{
    public class BaseEnemyAttackBehaviors : IEnemyAttack
    {
        private readonly Enemy _enemy;
        private readonly EnemyAnimationState _animationState;
        private readonly IEnemyAttackData _attackType;
        ...
        public BaseEnemyAttackBehaviors(EnemyAnimationState animationState, Transform enemyTransform, Player player, float attackCooldown, IEnemyAttackData attackType, int attackVariants)
        {
        ...
        public void TryAttack()
        {
            ...
            {
                if (_attackType.AttackType == AttackType.Melee)
                {
                ...
                else if (_attackType.AttackType == AttackType.Ranged)
                {
                    int attackVariant = GetAttackVariant();
                    _lastAttackTime = Time.time;
                ...
                else if (_attackType.AttackType == AttackType.Hybrid)
                {
                    HybridAttackData hybridType = (HybridAttackData)_attackType;
                ...
                else if (_attackType.AttackType == AttackType.Boss)
                {
                    BossAttackData bossType = (BossAttackData)_attackType;
        ...
        {
            if (_attackType.AttackType == AttackType.Hybrid)
            {
